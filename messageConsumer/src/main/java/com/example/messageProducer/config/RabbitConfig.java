...
public class RabbitConfig {
    ...
    @Bean
    Queue queueDevice(){return new Queue("fericire2", true);}

    @Bean
    DirectExchange exchangeDevice(){ return new DirectExchange("testexchange2");}

    @Bean
    Binding bindingDevice(Queue queue, DirectExchange exchange){
